...
<div class="my-3 p-3 bg-body rounded shadow-sm">
      ...
      @csrf
      <div class="pb-4">
        <div class="container-xl d-flex justify-content-center m-2 pb-2 fs-4">Presensi Mahasiswa / Dosen</div>
        <form class="d-flex" action="{{ url('absensi') }}" method="get">
            <input class="form-control me-1" type="search" name="katakunci" value="{{ Request::get('katakunci') }}" 
            placeholder="Masukkan kata kunci" aria-label="Search">
            <button class="btn btn-secondary btn-md" type="submit">Cari</button>
        </form>
      </div>
